...
![새 브랜치로 이동하는 예시](/assets/img/posts/git-learning/checkout-branch.png)
...
![상대 참조 예시](/assets/img/posts/git-learning/relative-ref.png)
...
![인터랙티브 리베이스 예시](/assets/img/posts/git-learning/interactive-rebase.png)
...
![rebase와 amend 예시](/assets/img/posts/git-learning/amend-rebase.png)
...
![git describe 예시](/assets/img/posts/git-learning/describe.png)
...
![브랜치 스파게티 예시](/assets/img/posts/git-learning/branch-spaghetti.png)
...
![원격 브랜치 참고](/assets/img/posts/git-learning/remote-branch-reference.png)
...
![git fetch와 git clone의 차이 1](/assets/img/posts/git-learning/fetch-vs-clone-1.png)

![git fetch와 git clone의 차이 2](/assets/img/posts/git-learning/fetch-vs-clone-2.png)
...
![git pull을 사용했을 때의 merge 예시](/assets/img/posts/git-learning/pull-merge-explanation.png)
...
![main 단계 완료](/assets/img/posts/git-learning/main-complete.png)

![원격 단계 완료](/assets/img/posts/git-learning/remote-complete.png)
